const Register = () => {
  return (
    <main>
      ...
      >
        <div className="text-left bg-babyBlue-bg lg:container xl:max-w-[1122px] mx-auto pb-4 max-sm:min-h-[30rem] md:h-[30rem] rounded-3xl md:rounded-[5rem] flex flex-col  justify-center gap-4 md:gap-4 lg:px-28 px-6 max-[380px]:px-4">
